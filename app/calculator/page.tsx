...
function CalculatorPageContent() {
  ...
  const handleSubmit = async (actualAmountInput?: string) => {
    ...
    try {
      ...
      const apiUrl = process.env.NODE_ENV === 'production' ? 'https://api-awdqlpezfa-uc.a.run.app/api/makeOrderWithDetail' : 'https://api-awdqlpezfa-uc.a.run.app/api/makeOrderWithDetail';
